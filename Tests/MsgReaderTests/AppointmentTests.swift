...
final class AppointmentTests: XCTestCase {
    public func testSimpleAppointment() throws {
        ...
        XCTAssertEqual(1642752849517.0, msg.conversationIndex!.header.currentFileTime.timeIntervalSince1970)
        XCTAssertEqual(GUID(0xA2798B5C, 0x8801, 0x4D52, 0xB20D, 0x81DCEF9FEE47), msg.conversationIndex!.header.guid)
        ...
        XCTAssertEqual(GUID(0xC900D166, 0x479B, 0x4C12, 0xBB9E, 0xC8DC29FA7341), msg.changeKey!.namespaceGuid)
        ...
        XCTAssertEqual(GUID(0xC900D166, 0x479B, 0x4C12, 0xBB9E, 0xC8DC29FA7341), msg.predecessorChangeList!.values[0].namespaceGuid)
    ...
    public func testRecurringAppointment() throws {
        ...
        XCTAssertEqual(["IOpenTypedFacet.EventLocations"], (msg.getProperty(guid: GUID(0xE550B918, 0x9859, 0x47B9, 0x8095, 0x97E4E72F1926), name: "ExtensionsList") as [String]?)!)
        XCTAssertEqual(0, (msg.getProperty(set: .appointment, lid: 0x00008245) as UInt32?)!)
        XCTAssertTrue(msg.rtfInSync!)
        XCTAssertEqual("pstreadertests@outlook.com", (msg.getProperty(id: .tagSenderName) as String?)!)
        XCTAssertNotNil(msg.rtfCompressed)
        ...
        XCTAssertEqual(1603368493.0, (msg.getProperty(guid: GUID(0x0B63E350, 0x9CCC, 0x11D0, 0xBCDB, 0x00805FCCCE04), name: "LastIndexingAttemptTime") as Date?)!.timeIntervalSince1970)
        XCTAssertEqual(.undefined, msg.nativeBody!)
        ...
        XCTAssertEqual(GUID(0xC900D166, 0x479B, 0x4C12, 0xBB9E, 0xC8DC29FA7341), msg.predecessorChangeList!.values[1].namespaceGuid)
        ...
        XCTAssertNil(msg.intendedBusyStatus)
        XCTAssertEqual("{\"Locations\":[{\"Name\":\"Location\"}]}", (msg.getProperty(guid: GUID(0xE550B918, 0x9859, 0x47B9, 0x8095, 0x97E4E72F1926), name: "IOpenTypedFacet.EventLocations") as String?)!)
        ...
        XCTAssertEqual(0, msg.appointmentTimeZoneDefinitionStartDisplay!.rules[0].stDaylightDate.wMilliseconds)
        XCTAssertFalse(msg.originatorDeliveryReportRequested!)
        XCTAssertEqual(GUID(0x98E62D67, 0x47B8, 0x4FFE, 0xA7E7, 0x63F3F1D7EFBB), (msg.getProperty(guid: GUID(0x0B63E350, 0x9CCC, 0x11D0, 0xBCDB, 0x00805FCCCE04), name: "BigFunnelCorrelationId") as GUID?)!)
        ...
        XCTAssertEqual("[{\"DisplayName\":\"Location\",\"LocationAnnotation\":\"\",\"LocationUri\":\"\",\"LocationStreet\":\"\",\"LocationCity\":\"\",\"LocationState\":\"\",\"LocationCountry\":\"\",\"LocationPostalCode\":\"\",\"LocationFullAddress\":\"\"}]", (msg.getProperty(guid: GUID(0xA719E259, 0x2A9A, 0x4FB8, 0xBAB3, 0x3A9F02970E4B), name: "Locations") as String?)!)
