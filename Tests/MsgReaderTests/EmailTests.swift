...
final class EmailTests: XCTestCase {
    ...
    func testReadVikramarsid1() throws {
        ...
        XCTAssertEqual(UUID(uuidString: "812B1FA4-BEA3-1019-9D6E-00DD010F5402"), (msg.attachments[0].embeddedMessage!.senderEntryId as? OneOffEntryID)!.providerUid)
        ...
        XCTAssertEqual(UUID(uuidString: "812B1FA4-BEA3-1019-9D6E-00DD010F5402"), (msg.attachments[0].embeddedMessage!.recipients[0].entryId as? OneOffEntryID)!.providerUid)
