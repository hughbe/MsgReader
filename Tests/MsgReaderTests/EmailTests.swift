...
final class EmailTests: XCTestCase {
    func testReadTeamMsgExtractor1() throws {
        ...
        XCTAssertEqual(GUID(0xA41F2B81, 0xA3BE, 0x1910, 0x9D6E, 0x00DD010F5402), (msg.receivedByEntryId as? OneOffEntryID)!.providerUid)
        ...
        XCTAssertEqual(GUID(0xA41F2B81, 0xA3BE, 0x1910, 0x9D6E, 0x00DD010F5402), (msg.receivedRepresentingEntryId as? OneOffEntryID)!.providerUid)
        ...
        XCTAssertEqual(38908432218.0, msg.conversationIndex!.header.currentFileTime.timeIntervalSince1970)
        XCTAssertEqual(GUID(0x43290378, 0x8667, 0xEC3D, 0xAE49, 0xA04D7733109D), msg.conversationIndex!.header.guid)
        ...
        XCTAssertEqual(GUID(0xA41F2B81, 0xA3BE, 0x1910, 0x9D6E, 0x00DD010F5402), (msg.recipients[0].entryId as? OneOffEntryID)!.providerUid)
        ...
        XCTAssertEqual(GUID(0xA41F2B81, 0xA3BE, 0x1910, 0x9D6E, 0x00DD010F5402), (msg.recipients[1].entryId as? OneOffEntryID)!.providerUid)
    ...
    func testReadTeamMsgExtractor2() throws {
        ...
        XCTAssertEqual(0x01, msg.conversationIndex!.header.reserved)
        XCTAssertEqual(949817751851.0, msg.conversationIndex!.header.currentFileTime.timeIntervalSince1970)
        XCTAssertEqual(GUID(0x55272F7F, 0x9CA0, 0x4AE3, 0x8A0F, 0xF778094D6DB8), msg.conversationIndex!.header.guid)
        XCTAssertEqual(0, msg.conversationIndex!.responseLevels.count)
        ...
        XCTAssertEqual(GUID(0xA41F2B81, 0xA3BE, 0x1910, 0x9D6E, 0x00DD010F5402), (msg.recipients[0].recipientEntryId as? OneOffEntryID)!.providerUid)
    ...
    func testReadVikramarsid1() throws {
        ...
        XCTAssertEqual(GUID(0xA41F2B81, 0xA3BE, 0x1910, 0x9D6E, 0x00DD010F5402), (msg.recipients[2].entryId as? OneOffEntryID)!.providerUid)
        ...
        XCTAssertEqual(GUID(0xA41F2B81, 0xA3BE, 0x1910, 0x9D6E, 0x00DD010F5402), (msg.recipients[3].entryId as? OneOffEntryID)!.providerUid)
        ...
        XCTAssertEqual([.unicodeOk, StoreSupportMask(rawValue: 0x00010E79)], msg.attachments[0].embeddedMessage!.storeSupportMask)
        XCTAssertEqual([0x53, 0x4D, 0x54, 0x50, 0x3A, 0x41, 0x5A, 0x55, 0x52, 0x45, 0x2D, 0x4E, 0x4F, 0x52, 0x45, 0x50, 0x4C, 0x59, 0x40, 0x4D, 0x49, 0x43, 0x52, 0x4F, 0x53, 0x4F, 0x46, 0x54, 0x2E, 0x43, 0x4F, 0x4D, 0x00], [UInt8](msg.attachments[0].embeddedMessage!.senderSearchKey!))
        XCTAssertEqual("<4132a7da-8948-4cdd-aaf0-4ebec7df964e@CH1GMEHUB08.gme.gbl>", (msg.attachments[0].embeddedMessage!.getProperty(id: .tagInternetMessageId) as String?)!)
        XCTAssertNotNil(msg.attachments[0].embeddedMessage!.rtfCompressed)
        XCTAssertEqual("Microsoft Azure", (msg.attachments[0].embeddedMessage!.getProperty(id: .tagSenderName) as String?)!)
        XCTAssertEqual(.readOnly, msg.attachments[0].embeddedMessage!.accessLevel!)
        XCTAssertEqual("", msg.attachments[0].embeddedMessage!.subjectPrefix!)
        XCTAssertTrue(msg.attachments[0].embeddedMessage!.rtfInSync!)
        XCTAssertEqual(.normal, msg.attachments[0].embeddedMessage!.importance!)
        XCTAssertEqual([.read], msg.attachments[0].embeddedMessage!.access)
        XCTAssertNotNil(msg.attachments[0].embeddedMessage!.bodyHtml)
        XCTAssertEqual([0xDB, 0x56, 0x95, 0x6B, 0x00, 0x00, 0x00, 0x00, 0x00, 0x47, 0x30, 0x4E, 0x79, 0x3C, 0xD6, 0x08], [UInt8](msg.attachments[0].embeddedMessage!.searchKey!))
        XCTAssertEqual([0x53, 0x4D, 0x54, 0x50, 0x3A, 0x41, 0x5A, 0x55, 0x52, 0x45, 0x2D, 0x4E, 0x4F, 0x52, 0x45, 0x50, 0x4C, 0x59, 0x40, 0x4D, 0x49, 0x43, 0x52, 0x4F, 0x53, 0x4F, 0x46, 0x54, 0x2E, 0x43, 0x4F, 0x4D, 0x00], [UInt8](msg.attachments[0].embeddedMessage!.sentRepresentingSearchKey!))
        XCTAssertEqual("admin@fegraph.onmicrosoft.com", msg.attachments[0].embeddedMessage!.displayTo!)
        XCTAssertEqual(65001, msg.attachments[0].embeddedMessage!.internetCodepage!)
        XCTAssertNotNil(msg.attachments[0].embeddedMessage!.transportMessageHeaders)
        XCTAssertEqual("Create a database on Azure in 90 seconds", msg.attachments[0].embeddedMessage!.normalizedSubject!)
        XCTAssertEqual("Create a database on Azure in 90 seconds", msg.attachments[0].embeddedMessage!.conversationTopic!)
        XCTAssertNotNil(msg.attachments[0].embeddedMessage!.body)
        XCTAssertEqual("Create a database on Azure in 90 seconds", msg.attachments[0].embeddedMessage!.subject!)
        XCTAssertEqual("SMTP", (msg.attachments[0].embeddedMessage!.getProperty(id: .tagSenderAddressType) as String?)!)
        XCTAssertEqual("azure-noreply@microsoft.com", msg.attachments[0].embeddedMessage!.senderEmailAddress!)
        XCTAssertEqual("Microsoft Azure", msg.attachments[0].embeddedMessage!.sentRepresentingName!)
        XCTAssertEqual([.read], msg.attachments[0].embeddedMessage!.messageFlags)
        XCTAssertEqual("azure-noreply@microsoft.com", msg.attachments[0].embeddedMessage!.sentRepresentingEmailAddress!)
        XCTAssertEqual(1540837011.0, msg.attachments[0].embeddedMessage!.creationTime!.timeIntervalSince1970)
        XCTAssertEqual(0x00000000, (msg.attachments[0].embeddedMessage!.senderEntryId as? OneOffEntryID)!.flags)
        XCTAssertEqual(GUID(0xA41F2B81, 0xA3BE, 0x1910, 0x9D6E, 0x00DD010F5402), (msg.attachments[0].embeddedMessage!.senderEntryId as? OneOffEntryID)!.providerUid)
        XCTAssertEqual(0x0000, (msg.attachments[0].embeddedMessage!.senderEntryId as? OneOffEntryID)!.version)
        XCTAssertEqual([.noRichInfo, .unicode], (msg.attachments[0].embeddedMessage!.senderEntryId as? OneOffEntryID)!.entryFlags)
        XCTAssertEqual("azure-noreply@microsoft.com", (msg.attachments[0].embeddedMessage!.senderEntryId as? OneOffEntryID)!.displayName)
        XCTAssertEqual("SMTP", (msg.attachments[0].embeddedMessage!.senderEntryId as? OneOffEntryID)!.addressType)
        XCTAssertEqual("azure-noreply@microsoft.com", (msg.attachments[0].embeddedMessage!.senderEntryId as? OneOffEntryID)!.emailAddress)
        XCTAssertEqual(1540837011.0, msg.attachments[0].embeddedMessage!.lastModificationTime!.timeIntervalSince1970)
        XCTAssertEqual("", msg.attachments[0].embeddedMessage!.displayBcc!)
        XCTAssertEqual("IPM.Note", msg.attachments[0].embeddedMessage!.messageClass!)
        XCTAssertEqual(1540692106.0, msg.attachments[0].embeddedMessage!.messageDeliveryTime!.timeIntervalSince1970)
        XCTAssertEqual("", msg.attachments[0].embeddedMessage!.displayCc!)

        XCTAssertEqual(1, msg.attachments[0].embeddedMessage!.recipients.count)
        XCTAssertEqual([0x00, 0x00, 0x00, 0x8F], [UInt8](msg.attachments[0].embeddedMessage!.recipients[0].instanceKey!))
        XCTAssertEqual("admin@fegraph.onmicrosoft.com", msg.attachments[0].embeddedMessage!.recipients[0].emailAddress!)
        XCTAssertEqual(.primaryRecipient, msg.attachments[0].embeddedMessage!.recipients[0].recipientType!)
        XCTAssertEqual("SMTP", msg.attachments[0].embeddedMessage!.recipients[0].addressType!)
        XCTAssertEqual("admin@fegraph.onmicrosoft.com", msg.attachments[0].embeddedMessage!.recipients[0].displayName!)
        XCTAssertEqual(0x00000000, (msg.attachments[0].embeddedMessage!.recipients[0].entryId as? OneOffEntryID)!.flags)
        XCTAssertEqual(GUID(0xA41F2B81, 0xA3BE, 0x1910, 0x9D6E, 0x00DD010F5402), (msg.attachments[0].embeddedMessage!.recipients[0].entryId as? OneOffEntryID)!.providerUid)
        XCTAssertEqual(0x0000, (msg.attachments[0].embeddedMessage!.recipients[0].entryId as? OneOffEntryID)!.version)
        XCTAssertEqual([.noRichInfo, .unicode], (msg.attachments[0].embeddedMessage!.recipients[0].entryId as? OneOffEntryID)!.entryFlags)
        XCTAssertEqual("admin@fegraph.onmicrosoft.com", (msg.attachments[0].embeddedMessage!.recipients[0].entryId as? OneOffEntryID)!.displayName)
        XCTAssertEqual("SMTP", (msg.attachments[0].embeddedMessage!.recipients[0].entryId as? OneOffEntryID)!.addressType)
        XCTAssertEqual("admin@fegraph.onmicrosoft.com", (msg.attachments[0].embeddedMessage!.recipients[0].entryId as? OneOffEntryID)!.emailAddress)
        XCTAssertEqual(0, msg.attachments[0].embeddedMessage!.recipients[0].rowid!)
        XCTAssertEqual([0x53, 0x4D, 0x54, 0x50, 0x3A, 0x41, 0x44, 0x4D, 0x49, 0x4E, 0x40, 0x46, 0x45, 0x47, 0x52, 0x41, 0x50, 0x48, 0x2E, 0x4F, 0x4E, 0x4D, 0x49, 0x43, 0x52, 0x4F, 0x53, 0x4F, 0x46, 0x54, 0x2E, 0x43, 0x4F, 0x4D, 0x00], [UInt8](msg.attachments[0].embeddedMessage!.recipients[0].searchKey!))

        XCTAssertEqual(0, msg.attachments[0].embeddedMessage!.attachments.count)
    ...
    func testReadVikramarsid2() throws {
        ...
        XCTAssertEqual(GUID(0xC840A7DC, 0x42C0, 0x1A10, 0xB4B9, 0x08002B2FE182), (msg.lastModifierEntryId as? AddressBookEntryID)!.providerUid)
        ...
        XCTAssertEqual(0x01, msg.conversationIndex!.header.reserved)
        XCTAssertEqual(1127062544684.0, msg.conversationIndex!.header.currentFileTime.timeIntervalSince1970)
        XCTAssertEqual(GUID(0x53704B2C, 0x00D2, 0x264E, 0x8BBC, 0x6ED71B54C94E), msg.conversationIndex!.header.guid)
        XCTAssertEqual(0, msg.conversationIndex!.responseLevels.count)
        XCTAssertTrue(msg.rtfInSync!)
        ...
        XCTAssertEqual(GUID(0xC840A7DC, 0x42C0, 0x1A10, 0xB4B9, 0x08002B2FE182), (msg.creatorEntryId as? AddressBookEntryID)!.providerUid)
    ...
    func testReadVikramarsid3() throws {
        ...
        XCTAssertEqual(0x01, msg.conversationIndex!.header.reserved)
        XCTAssertEqual(92867185255.0, msg.conversationIndex!.header.currentFileTime.timeIntervalSince1970)
        XCTAssertEqual(GUID(0xD5BACD40, 0xC07E, 0x4249, 0xB8B5, 0x90E7721B2BE3), msg.conversationIndex!.header.guid)
        XCTAssertEqual(0, msg.conversationIndex!.responseLevels.count)
    ...
    func testReadConfusedCat1() throws {
        ...
        XCTAssertEqual(0x01, msg.conversationIndex!.header.reserved)
        XCTAssertEqual(1554060084354.0, msg.conversationIndex!.header.currentFileTime.timeIntervalSince1970)
        XCTAssertEqual(GUID(0x2A1EA50C, 0xE22B, 0x5741, 0xB8B0, 0x41AFA2E3CBA3), msg.conversationIndex!.header.guid)
        XCTAssertEqual(2, msg.conversationIndex!.responseLevels.count)
        XCTAssertEqual(0x1F84C138, msg.conversationIndex!.responseLevels[0].deltaTime)
        XCTAssertTrue(msg.conversationIndex!.responseLevels[0].deltaCode)
        XCTAssertEqual(4, msg.conversationIndex!.responseLevels[0].random)
        XCTAssertEqual(15, msg.conversationIndex!.responseLevels[1].level)
        XCTAssertEqual(18270, msg.conversationIndex!.responseLevels[1].deltaTime)
        XCTAssertTrue(msg.conversationIndex!.responseLevels[0].deltaCode)
        XCTAssertEqual(5, msg.conversationIndex!.responseLevels[1].random)
        XCTAssertEqual(15, msg.conversationIndex!.responseLevels[1].level)
        XCTAssertNotNil(msg.transportMessageHeaders)
    ...
    func testReadConfusedCat2() throws {
        ...
        XCTAssertEqual(GUID(0xC840A7DC, 0x42C0, 0x1A10, 0xB4B9, 0x08002B2FE182), (msg.receivedRepresentingEntryId as? AddressBookEntryID)!.providerUid)
        ...
        XCTAssertEqual(GUID(0xC840A7DC, 0x42C0, 0x1A10, 0xB4B9, 0x08002B2FE182), (msg.receivedByEntryId as? AddressBookEntryID)!.providerUid)
        ...
        XCTAssertEqual(GUID(0xC840A7DC, 0x42C0, 0x1A10, 0xB4B9, 0x08002B2FE182), (msg.senderEntryId as? AddressBookEntryID)!.providerUid)
        ...
        XCTAssertEqual(GUID(0x0CD402F7, 0x32B0, 0x445C, 0xB468, 0x0D8A5A3C1B49), msg.changeKey!.namespaceGuid)
        ...
        XCTAssertEqual(GUID(0x0CD402F7, 0x32B0, 0x445C, 0xB468, 0x0D8A5A3C1B49), msg.predecessorChangeList!.values[0].namespaceGuid)
        ...
        XCTAssertEqual(GUID(0xC840A7DC, 0x42C0, 0x1A10, 0xB4B9, 0x08002B2FE182), (msg.sentRepresentingEntryId as? AddressBookEntryID)!.providerUid)
        ...
        XCTAssertEqual(0x01, msg.conversationIndex!.header.reserved)
        XCTAssertEqual(574330132919.0, msg.conversationIndex!.header.currentFileTime.timeIntervalSince1970)
        XCTAssertEqual(GUID(0x4F5ADF8F, 0x7B67, 0x4D20, 0xBFEF, 0x0C790A5F9177), msg.conversationIndex!.header.guid)
        XCTAssertEqual(0, msg.conversationIndex!.responseLevels.count)
        XCTAssertEqual("EX", (msg.getProperty(id: .tagCreatorAddressType) as String?)!)
        ...
        XCTAssertEqual("BT=1;II=01CDC1C251524F5ADF8F7B674D20BFEF0C790A5F9177;FIXUP=1.811;Version=Version 14.2 (Build 318.0), Stage=H4", (msg.getProperty(guid: GUID(0x33EBA41F, 0x7AA8, 0x422E, 0xBE7B, 0x79E1A98E54B3), name: "ConversationIndexTrackingEx") as String?)!)
        ...
        XCTAssertEqual(.mailUser, msg.recipients[0].objectType!)
        XCTAssertEqual(0, (msg.recipients[0].getProperty(id: .PR_RECIPIENT_TRACKSTATUS_DELIVERY) as UInt32?)!)
        ...
        XCTAssertEqual(GUID(0xC840A7DC, 0x42C0, 0x1A10, 0xB4B9, 0x08002B2FE182), (msg.recipients[0].recipientEntryId as? AddressBookEntryID)!.providerUid)
        ...
        XCTAssertEqual(GUID(0xC840A7DC, 0x42C0, 0x1A10, 0xB4B9, 0x08002B2FE182), (msg.recipients[0].entryId as? AddressBookEntryID)!.providerUid)
        ...
        XCTAssertEqual(.sendable, msg.recipients[0].recipientFlags!)
        XCTAssertEqual(.mailUser, msg.recipients[0].displayType!)
        XCTAssertEqual(0, (msg.recipients[0].getProperty(id: .PR_RECIPIENT_TRACKSTATUS_RECALL) as UInt32?)!)
        XCTAssertEqual(0, (msg.recipients[0].getProperty(id: .PR_RECIPIENT_TRACKSTATUS_READ) as UInt32?)!)
    ...
    func testReadConfusedCat3() throws {
        ...
        XCTAssertEqual(528793912, msg.conversationIndex!.responseLevels[0].deltaTime)
        XCTAssertTrue(msg.conversationIndex!.responseLevels[0].deltaCode)
        XCTAssertEqual(4, msg.conversationIndex!.responseLevels[0].random)
        XCTAssertEqual(18270, msg.conversationIndex!.responseLevels[1].deltaTime)
        XCTAssertTrue(msg.conversationIndex!.responseLevels[0].deltaCode)
        XCTAssertEqual(5, msg.conversationIndex!.responseLevels[1].random)
        XCTAssertEqual(33685595, msg.conversationIndex!.responseLevels[2].deltaTime)
        XCTAssertTrue(msg.conversationIndex!.responseLevels[0].deltaCode)
        XCTAssertEqual(3, msg.conversationIndex!.responseLevels[2].random)
        XCTAssertEqual([], [UInt8]((msg.getProperty(set: .common, lid: 0x000085C3) as Data?)!))
    ...
    func testReadConfusedCat4() throws {
        ...
        XCTAssertTrue(msg.conversationIndexTracking!)
        XCTAssertEqual(.html, msg.nativeBody!)
        XCTAssertEqual("BT=0;II=<invalid>;FIXUP=0.8704;Version=Version 15.1 (Build 466.0), Stage=H12", (msg.getProperty(guid: GUID(0x33EBA41F, 0x7AA8, 0x422E, 0xBE7B, 0x79E1A98E54B3), name: "ConversationIndexTrackingEx") as String?)!)
        XCTAssertEqual(0x00000000, (msg.receivedRepresentingEntryId as? AddressBookEntryID)!.flags)
        XCTAssertEqual(GUID(0xC840A7DC, 0x42C0, 0x1A10, 0xB4B9, 0x08002B2FE182), (msg.receivedRepresentingEntryId as? AddressBookEntryID)!.providerUid)
        XCTAssertEqual(0x00000001, (msg.receivedRepresentingEntryId as? AddressBookEntryID)!.version)
        XCTAssertEqual(.localMailUser, (msg.receivedRepresentingEntryId as? AddressBookEntryID)!.type)
        ...
        XCTAssertEqual(GUID(0xA41F2B81, 0xA3BE, 0x1910, 0x9D6E, 0x00DD010F5402), (msg.lastModifierEntryId as? OneOffEntryID)!.providerUid)
        ...
        XCTAssertEqual("#", (msg.getProperty(guid: GUID(0x31805AB8, 0x3E92, 0x11DC, 0x879C, 0x00061B031004), name: "GpgOL Sig Status") as String?)!)
        XCTAssertFalse(msg.messageCcMe!)
        XCTAssertEqual("IPM.Note", msg.messageClass!)
        ...
        XCTAssertEqual(GUID(0xA41F2B81, 0xA3BE, 0x1910, 0x9D6E, 0x00DD010F5402), (msg.replyRecipientEntries!.flatEntries[0].entryID as? OneOffEntryID)!.providerUid)
        ...
        XCTAssertEqual(GUID(0xDED02E5B, 0x0473, 0x4B1B, 0x8BF3, 0xD1C760069FF2), msg.predecessorChangeList!.values[0].namespaceGuid)
        XCTAssertEqual([0x00, 0x00, 0x58, 0xAE], msg.predecessorChangeList!.values[0].localId)
        XCTAssertEqual(GUID(0x92462B83, 0x2252, 0x4C27, 0x939E, 0xB444044A918D), msg.predecessorChangeList!.values[1].namespaceGuid)
        ...
        XCTAssertEqual(GUID(0xDED02E5B, 0x0473, 0x4B1B, 0x8BF3, 0xD1C760069FF2), msg.changeKey!.namespaceGuid)
        ...
        XCTAssertEqual("en", (msg.getProperty(guid: GUID(0x0B63E350, 0x9CCC, 0x11D0, 0xBCDB, 0x00805FCCCE04), name: "DetectedLanguage") as String?)!)
        XCTAssertFalse((msg.getProperty(set: .messaging, name: "IsReadReceipt") as Bool?)!)
        XCTAssertEqual(GUID(0xA24E4D1D, 0xA86F, 0x4BEA, 0x469F, 0x08D463B8682C), (msg.getProperty(set: .common, name: "NetworkMessageId") as GUID?)!)
        XCTAssertEqual(0x01, msg.conversationIndex!.header.reserved)
        XCTAssertEqual(1150424967751.0, msg.conversationIndex!.header.currentFileTime.timeIntervalSince1970)
        XCTAssertEqual(GUID(0x4F3B0189, 0x03F1, 0x0A46, 0x92FD, 0x917ACB95D80B), msg.conversationIndex!.header.guid)
        XCTAssertEqual(0, msg.conversationIndex!.responseLevels.count)
    ...
    func testReadConfusedCat5() throws {
        ...
        XCTAssertEqual(GUID(0xE4F28357, 0x92F5, 0x482D, 0x0184, 0x08D361EA2C73), (msg.getProperty(set: .common, name: "NetworkMessageId") as GUID?)!)
        ...
        XCTAssertEqual(1, msg.predecessorChangeList!.values.count)
        XCTAssertEqual(GUID(0x0594BEF1, 0xFE4A, 0x499F, 0x8A72, 0xE861E1086C1B), msg.predecessorChangeList!.values[0].namespaceGuid)
        ...
        XCTAssertEqual(.notAssigned, msg.taskMode!)
        XCTAssertEqual("BT=2;II=[CID=1025e1ac-51e2-f34d-b9cc-ef9c442c4ed1;IDXHEAD=D193D2FFC2;IDXCOUNT=1];SBMID=4;FIXUP=8.3239;Version=Version 15.1 (Build 447.0), Stage=H13", (msg.getProperty(guid: GUID(0x33EBA41F, 0x7AA8, 0x422E, 0xBE7B, 0x79E1A98E54B3), name: "ConversationIndexTrackingEx") as String?)!)
        ...
        XCTAssertEqual(GUID(0xC8E99525, 0x533E, 0x43C2, 0xBAEF, 0xEEF6792FF6A0), (msg.getProperty(set: .xmlExtractedEntities, name: "InferenceMessageIdentifier") as GUID?)!)
        XCTAssertFalse(msg.messageCcMe!)
        ...
        XCTAssertEqual(GUID(0x0594BEF1, 0xFE4A, 0x499F, 0x8A72, 0xE861E1086C1B), msg.changeKey!.namespaceGuid)
        ...
        XCTAssertEqual("de", (msg.getProperty(guid: GUID(0x0B63E350, 0x9CCC, 0x11D0, 0xBCDB, 0x00805FCCCE04), name: "DetectedLanguage") as String?)!)
        ...
        XCTAssertEqual("EX", (msg.getProperty(id: .tagSenderAddressType) as String?)!)
        XCTAssertEqual(0x01, msg.conversationIndex!.header.reserved)
        XCTAssertEqual(1831284788918.0, msg.conversationIndex!.header.currentFileTime.timeIntervalSince1970)
        XCTAssertEqual(GUID(0xACE12510, 0xE251, 0x4DF3, 0xB9CC, 0xEF9C442C4ED1), msg.conversationIndex!.header.guid)
        XCTAssertEqual(0, msg.conversationIndex!.responseLevels.count)
        XCTAssertEqual(0x00160000, msg.internetMailOverrideFormat!)
    ...
    func testReadConfusedCat6() throws {
        ...
        XCTAssertEqual(1, msg.predecessorChangeList!.values.count)
        XCTAssertEqual(GUID(0x65FE5A49, 0x8B39, 0x44EE, 0x88C4, 0xB6897273D916), msg.predecessorChangeList!.values[0].namespaceGuid)
        ...
        XCTAssertEqual(0x01, msg.conversationIndex!.header.reserved)
        XCTAssertEqual(789686637600.0, msg.conversationIndex!.header.currentFileTime.timeIntervalSince1970)
        XCTAssertEqual(GUID(0xC1C0E99E, 0x736D, 0x4BE4, 0x901D, 0x5759DD2D07BF), msg.conversationIndex!.header.guid)
        XCTAssertEqual(1, msg.conversationIndex!.responseLevels.count)
        XCTAssertEqual(62329313, msg.conversationIndex!.responseLevels[0].deltaTime)
        XCTAssertFalse(msg.conversationIndex!.responseLevels[0].deltaCode)
        XCTAssertEqual(9, msg.conversationIndex!.responseLevels[0].random)
        XCTAssertEqual("Robert Duncan", (msg.getProperty(id: .tagSenderName) as String?)!)
        XCTAssertEqual(GUID(0x65FE5A49, 0x8B39, 0x44EE, 0x88C4, 0xB6897273D916), msg.changeKey!.namespaceGuid)
        ...
        XCTAssertEqual(GUID(0xA41F2B81, 0xA3BE, 0x1910, 0x9D6E, 0x00DD010F5402), (msg.recipients[1].recipientEntryId as? OneOffEntryID)!.providerUid)
    ...
    func testReadConfusedCat7() throws {
        ...
        XCTAssertEqual(0x01, msg.conversationIndex!.header.reserved)
        XCTAssertEqual(672396014805.0, msg.conversationIndex!.header.currentFileTime.timeIntervalSince1970)
        XCTAssertEqual(GUID(0x550F33BB, 0xB536, 0x494F, 0x8CEB, 0x041C084C42C0), msg.conversationIndex!.header.guid)
        XCTAssertEqual(0, msg.conversationIndex!.responseLevels.count)
        XCTAssertNotNil(msg.rtfCompressed)
    ...
    func testReadSicos19771() throws {
        ...
        XCTAssertFalse((msg.getProperty(guid: GUID(0x0B63E350, 0x9CCC, 0x11D0, 0xBCDB, 0x00805FCCCE04), name: "IsPartiallyIndexed") as Bool?)!)
        ...
        XCTAssertNotNil(msg.transportMessageHeaders)
        XCTAssertEqual("EX", msg.receivedByAddressType!)
        XCTAssertEqual(GUID(0x1859B757, 0x721E, 0x4FA4, 0x8490, 0xD7B6A21E37B9), (msg.getProperty(guid: GUID(0x0B63E350, 0x9CCC, 0x11D0, 0xBCDB, 0x00805FCCCE04), name: "BigFunnelCorrelationId") as GUID?)!)
        ...
        XCTAssertFalse(msg.useTnef!)
        XCTAssertEqual(GUID(0xC708CED8, 0xAC98, 0x4383, 0x8743, 0x1BB5B4675E81), (msg.getProperty(set: .xmlExtractedEntities, name: "InferenceMessageIdentifier") as GUID?)!)
        ...
        XCTAssertEqual("EX", (msg.getProperty(id: .tagSenderAddressType) as String?)!)
        XCTAssertEqual(0x01, msg.conversationIndex!.header.reserved)
        XCTAssertEqual(1240046600337.0, msg.conversationIndex!.header.currentFileTime.timeIntervalSince1970)
        XCTAssertEqual(GUID(0xB02CC035, 0x250F, 0x4D66, 0x9B17, 0x2E241565867B), msg.conversationIndex!.header.guid)
        XCTAssertEqual(0, msg.conversationIndex!.responseLevels.count)
        XCTAssertFalse((msg.getProperty(set: .messaging, name: "IsReadReceipt") as Bool?)!)
        ...
        XCTAssertEqual(1, msg.predecessorChangeList!.values.count)
        XCTAssertEqual(GUID(0xCE58E2F6, 0x3358, 0x4A47, 0xA8B6, 0x78DBA6482C22), msg.predecessorChangeList!.values[0].namespaceGuid)
        ...
        XCTAssertEqual(GUID(0x2E7E6AFA, 0xED05, 0x4F5D, 0x56DB, 0x08D77703D2F9), (msg.getProperty(set: .common, name: "NetworkMessageId") as GUID?)!)
        ...
        XCTAssertEqual("nl", (msg.getProperty(guid: GUID(0x0B63E350, 0x9CCC, 0x11D0, 0xBCDB, 0x00805FCCCE04), name: "DetectedLanguage") as String?)!)
        XCTAssertNotNil(msg.tnefCorrelationKey)
        ...
        XCTAssertEqual(1575276261.0, (msg.getProperty(guid: GUID(0x0B63E350, 0x9CCC, 0x11D0, 0xBCDB, 0x00805FCCCE04), name: "LastIndexingAttemptTime") as Date?)!.timeIntervalSince1970)
        ...
        XCTAssertEqual("Client=MSExchangeRPC", (msg.getProperty(set: .messaging, name: "ClientInfo") as String?)!)
        XCTAssertEqual(GUID(0xCE58E2F6, 0x3358, 0x4A47, 0xA8B6, 0x78DBA6482C22), msg.changeKey!.namespaceGuid)
        ...
        XCTAssertEqual("BT=1;II=[CID=35c02cb0-0f25-664d-9b17-2e241565867b;IDXHEAD=D5A8ECADB5;IDXCOUNT=1];SBMID=25;RTP=Self;TFR=NotForking;FIXUP=27.4166;Version=Version 15.20 (Build 2495.0), Stage=H13;UP=10;DP=1C5;QT=6", (msg.getProperty(guid: GUID(0x33EBA41F, 0x7AA8, 0x422E, 0xBE7B, 0x79E1A98E54B3), name: "ConversationIndexTrackingEx") as String?)!)
        XCTAssertEqual([.unicodeOk, StoreSupportMask(rawValue: 0x00000E79)], msg.storeSupportMask)
        XCTAssertEqual([.read], msg.access)
        XCTAssertEqual(0x00000000, (msg.senderEntryId as? AddressBookEntryID)!.flags)
        XCTAssertEqual(GUID(0xC840A7DC, 0x42C0, 0x1A10, 0xB4B9, 0x08002B2FE182), (msg.senderEntryId as? AddressBookEntryID)!.providerUid)
    ...
    func testReadSicos19772() throws {
        ...
        XCTAssertEqual(GUID(0x00340031, 0x0065, 0x0031, 0x3800, 0x64002D003600), (msg.entryId as? GeneralEntryID)!.providerUid)
        ...
        XCTAssertEqual(GUID(0x00350062, 0x0033, 0x0038, 0x3400, 0x39002D006500), (msg.recipients[0].entryId as? GeneralEntryID)!.providerUid)
        ...
        XCTAssertEqual(GUID(0x00610031, 0x0066, 0x0065, 0x3500, 0x32002D006100), (msg.recipients[1].entryId as? GeneralEntryID)!.providerUid)
        ...
        XCTAssertEqual(GUID(0x00350032, 0x0034, 0x0063, 0x3300, 0x30002D003100), (msg.recipients[2].entryId as? GeneralEntryID)!.providerUid)
    ...
    func testReadSicos19773() throws {
        ...
        XCTAssertNotNil(msg.body)
        XCTAssertFalse(msg.`private`!)
        XCTAssertEqual("BT=7;II=01D34BD0DEB63F62F427259045958B0068D1BB58684A;FIXUP=7.2008;Version=Version 14.3 (Build 361.0), Stage=H4", (msg.getProperty(guid: GUID(0x33EBA41F, 0x7AA8, 0x422E, 0xBE7B, 0x79E1A98E54B3), name: "ConversationIndexTrackingEx") as String?)!)
        ...
        XCTAssertEqual("IPM.Note", msg.messageClass!)
        XCTAssertEqual(GUID(0xB712A46B, 0xD2BB, 0x42FD, 0x8612, 0x93C22F31BF8F), msg.changeKey!.namespaceGuid)
        ...
        XCTAssertEqual(0x01, msg.conversationIndex!.header.reserved)
        XCTAssertEqual(1593156958621.0, msg.conversationIndex!.header.currentFileTime.timeIntervalSince1970)
        XCTAssertEqual(GUID(0x3F62F427, 0x2590, 0x4595, 0x8B00, 0x68D1BB58684A), msg.conversationIndex!.header.guid)
        XCTAssertEqual(0, msg.conversationIndex!.responseLevels.count)
        XCTAssertEqual(1, msg.predecessorChangeList!.values.count)
        XCTAssertEqual(GUID(0xB712A46B, 0xD2BB, 0x42FD, 0x8612, 0x93C22F31BF8F), msg.predecessorChangeList!.values[0].namespaceGuid)
    ...
    func testReadSicos19774() throws {
        ...
        XCTAssertEqual(1033, msg.messageLocaleId!)
        XCTAssertEqual(0x01, msg.conversationIndex!.header.reserved)
        XCTAssertEqual(1664989372677.0, msg.conversationIndex!.header.currentFileTime.timeIntervalSince1970)
        XCTAssertEqual(GUID(0xE5B589B0, 0xCFE7, 0x4409, 0xBF6B, 0x2C3CCD2D01C1), msg.conversationIndex!.header.guid)
        XCTAssertEqual(0, msg.conversationIndex!.responseLevels.count)
        ...
        XCTAssertEqual(20127, msg.internetCodepage!)
        XCTAssertEqual("EX", msg.receivedByAddressType!)
        XCTAssertEqual("BT=0;II=01D34BDDE8AEE5B589B0CFE74409BF6B2C3CCD2D01C1;FIXUP=0.7301;Version=Version 14.3 (Build 361.0), Stage=H4", (msg.getProperty(guid: GUID(0x33EBA41F, 0x7AA8, 0x422E, 0xBE7B, 0x79E1A98E54B3), name: "ConversationIndexTrackingEx") as String?)!)
        XCTAssertTrue(msg.trustSender!)
        XCTAssertTrue(msg.rtfInSync!)
        XCTAssertEqual(.normal, msg.priority!)
        XCTAssertEqual("IPM.Note", msg.messageClass!)
    ...
    func testReadSicos19775() throws {
        ...
        XCTAssertEqual("BT=3;II=01D34BD0D6A0F94FEEB3EF5549B5AF9FA616B028595F;FIXUP=3.4516;Version=Version 14.3 (Build 361.0), Stage=H4", (msg.getProperty(guid: GUID(0x33EBA41F, 0x7AA8, 0x422E, 0xBE7B, 0x79E1A98E54B3), name: "ConversationIndexTrackingEx") as String?)!)
        XCTAssertEqual(.normal, msg.importance!)
        ...
        XCTAssertEqual(1033, msg.messageLocaleId!)
        XCTAssertEqual(0x01, msg.conversationIndex!.header.reserved)
        XCTAssertEqual(1534891638442.0, msg.conversationIndex!.header.currentFileTime.timeIntervalSince1970)
        XCTAssertEqual(GUID(0xF94FEEB3, 0xEF55, 0x49B5, 0xAF9F, 0xA616B028595F), msg.conversationIndex!.header.guid)
        XCTAssertEqual(0, msg.conversationIndex!.responseLevels.count)
        XCTAssertEqual(0, (msg.getProperty(id: .tagReceivedByFlags) as UInt32?)!)
        XCTAssertEqual("Clean, bases: 23/10/2017 05:31:00", (msg.getProperty(set: .internetHeaders, name: "x-kse-antivirus-info") as String?)!)
    ...
    func testReadSicos19776() throws {
        ...
        XCTAssertEqual("Chris.Wilson@leeds.gov.uk", msg.internetAccountName!)
        XCTAssertEqual(0x01, msg.conversationIndex!.header.reserved)
        XCTAssertEqual(1776509758450.0, msg.conversationIndex!.header.currentFileTime.timeIntervalSince1970)
        XCTAssertEqual(GUID(0x55E92191, 0x88D1, 0x4BED, 0xAEFF, 0x67D99F48F800), msg.conversationIndex!.header.guid)
        XCTAssertEqual(0, msg.conversationIndex!.responseLevels.count)
        XCTAssertEqual(.readOnly, msg.accessLevel!)
        XCTAssertEqual(0, (msg.getProperty(id: .tagReceivedByFlags) as UInt32?)!)
        XCTAssertEqual(1033, msg.messageLocaleId!)
        ...
        XCTAssertEqual("", msg.displayBcc!)
        XCTAssertEqual("Wilson, Chris", msg.lastModifierName!)
        XCTAssertEqual("BT=0;II=01D34BDDF82855E9219188D14BEDAEFF67D99F48F800;FIXUP=0.9046;Version=Version 14.3 (Build 361.0), Stage=H4", (msg.getProperty(guid: GUID(0x33EBA41F, 0x7AA8, 0x422E, 0xBE7B, 0x79E1A98E54B3), name: "ConversationIndexTrackingEx") as String?)!)
    ...
    func testReadSicos19777() throws {
        ...
        XCTAssertEqual("Chris.Wilson@leeds.gov.uk", msg.internetAccountName!)
        XCTAssertEqual(.readOnly, msg.accessLevel!)
        XCTAssertEqual("BT=3;II=01D34BD0E53941106FB80C804CBC8F19A779D168848A;FIXUP=3.486;Version=Version 14.3 (Build 361.0), Stage=H4", (msg.getProperty(guid: GUID(0x33EBA41F, 0x7AA8, 0x422E, 0xBE7B, 0x79E1A98E54B3), name: "ConversationIndexTrackingEx") as String?)!)
        XCTAssertFalse((msg.getProperty(set: .messaging, name: "IsSigned") as Bool?)!)
        XCTAssertEqual("EX", msg.receivedRepresentingAddressType!)
        XCTAssertEqual(1508744136.0, msg.lastModificationTime!.timeIntervalSince1970)
        XCTAssertEqual(0x00000000, (msg.receivedRepresentingEntryId as? AddressBookEntryID)!.flags)
        ...
        XCTAssertEqual("Wilson, Chris\u{00}", msg.displayTo!)
        XCTAssertEqual(0x01, msg.conversationIndex!.header.reserved)
        XCTAssertEqual(1640078837238.0, msg.conversationIndex!.header.currentFileTime.timeIntervalSince1970)
        XCTAssertEqual(GUID(0x41106FB8, 0x0C80, 0x4CBC, 0x8F19, 0xA779D168848A), msg.conversationIndex!.header.guid)
        XCTAssertEqual(0, msg.conversationIndex!.responseLevels.count)
        XCTAssertEqual("Chris.Wilson@leeds.gov.uk", (msg.getProperty(id: .tagSenderSmtpAddress) as String?)!)
        XCTAssertEqual("EX", (msg.getProperty(id: .tagCreatorAddressType) as String?)!)
        XCTAssertEqual(0, (msg.getProperty(id: .tagReceivedByFlags) as UInt32?)!)
    ...
    func testReadSicos19778() throws {
        ...
        XCTAssertEqual("Chris.Wilson@leeds.gov.uk", msg.sentRepresentingSmtpAddress!)
        XCTAssertEqual(0x01, msg.conversationIndex!.header.reserved)
        XCTAssertEqual(1660204298073.0, msg.conversationIndex!.header.currentFileTime.timeIntervalSince1970)
        XCTAssertEqual(GUID(0xC4D6B375, 0xB980, 0x47F8, 0x9131, 0x80F1A169FF89), msg.conversationIndex!.header.guid)
        XCTAssertEqual(0, msg.conversationIndex!.responseLevels.count)
        XCTAssertEqual(.plainText, msg.messageEditorFormat!)
        XCTAssertEqual(1508749622.0, msg.lastModificationTime!.timeIntervalSince1970)
        XCTAssertFalse(msg.smartNoAttach!)
        ...
        XCTAssertEqual(.readOnly, msg.accessLevel!)
        XCTAssertEqual("Chris.Wilson@leeds.gov.uk", (msg.getProperty(id: .tagSenderSmtpAddress) as String?)!)
        XCTAssertEqual("BT=0;II=01D34BDDE804C4D6B375B98047F8913180F1A169FF89;FIXUP=0.2669;Version=Version 14.3 (Build 361.0), Stage=H4", (msg.getProperty(guid: GUID(0x33EBA41F, 0x7AA8, 0x422E, 0xBE7B, 0x79E1A98E54B3), name: "ConversationIndexTrackingEx") as String?)!)
        XCTAssertEqual("", msg.subjectPrefix!)
        XCTAssertEqual("", msg.displayCc!)
        XCTAssertEqual("Wilson, Chris\u{00}", msg.displayTo!)
        XCTAssertEqual(1, msg.predecessorChangeList!.values.count)
    ...
    func testReadMine1() throws {
        ...
        XCTAssertEqual(GUID(0x75EB2FE9, 0x5096, 0x8644, 0x83B8, 0x7DE522AA4948), msg.changeKey!.namespaceGuid)
        ...
        XCTAssertEqual(0x01, msg.conversationIndex!.header.reserved)
        XCTAssertEqual(849471922652.0, msg.conversationIndex!.header.currentFileTime.timeIntervalSince1970)
        XCTAssertEqual(GUID(0xCA468532, 0xCAF4, 0x7508, 0xC195, 0x1C829A9161F8), msg.conversationIndex!.header.guid)
        XCTAssertEqual(0, msg.conversationIndex!.responseLevels.count)
        ...
        XCTAssertEqual(1, msg.predecessorChangeList!.values.count)
        XCTAssertEqual(GUID(0x75EB2FE9, 0x5096, 0x8644, 0x83B8, 0x7DE522AA4948), msg.predecessorChangeList!.values[0].namespaceGuid)
    ...
    func testReadMine2() throws {
        ...
        XCTAssertEqual(0x01, msg.conversationIndex!.header.reserved)
        XCTAssertEqual(429651994890.0, msg.conversationIndex!.header.currentFileTime.timeIntervalSince1970)
        XCTAssertEqual(GUID(0xF41AEE48, 0xD7E0, 0x4F2E, 0x8BDD, 0x56FCA6568479), msg.conversationIndex!.header.guid)
        XCTAssertEqual(0, msg.conversationIndex!.responseLevels.count)
        XCTAssertFalse(msg.`private`!)
        XCTAssertEqual(1033, msg.messageLocaleId!)
        ...
        XCTAssertEqual(GUID(0x2907DA59, 0xAF9D, 0x4A5C, 0xB20C, 0x8B81A78C96C0), msg.reportTag!.searchFolderEntryId!.providerUid)
        XCTAssertEqual(.privateFolder, msg.reportTag!.searchFolderEntryId!.folderType)
        XCTAssertEqual(GUID(0x108EB6C3, 0x75F7, 0xCE11, 0xB4CD, 0x00AA00BBB6E6), msg.reportTag!.searchFolderEntryId!.databaseGuid)
        ...
        XCTAssertEqual(GUID(0x75EB2FE9, 0x5096, 0x8644, 0x83B8, 0x7DE522AA4948), msg.predecessorChangeList!.values[1].namespaceGuid)
        ...
        XCTAssertEqual(GUID(0xA41F2B81, 0xA3BE, 0x1910, 0x9D6E, 0x00DD010F5402), (msg.readReceiptEntryId as? OneOffEntryID)!.providerUid)
    ...
    func testReadMine4() throws {
        ...
        XCTAssertEqual(GUID(0xF41AEE48, 0xD7E0, 0x4F2E, 0x8BDD, 0x56FCA6568479), msg.conversationIndex!.header.guid)
        XCTAssertEqual(1, msg.conversationIndex!.responseLevels.count)
        XCTAssertEqual(137925, msg.conversationIndex!.responseLevels[0].deltaTime)
        XCTAssertFalse(msg.conversationIndex!.responseLevels[0].deltaCode)
        XCTAssertEqual(12, msg.conversationIndex!.responseLevels[0].random)
        XCTAssertTrue(msg.rtfInSync!)
    ...
    func testReadMine5() throws {
        ...
        XCTAssertEqual(0x01, msg.conversationIndex!.header.reserved)
        XCTAssertEqual(166923251628.0, msg.conversationIndex!.header.currentFileTime.timeIntervalSince1970)
        XCTAssertEqual(GUID(0x8F7622C6, 0x9F6C, 0x4206, 0x98B3, 0x779886E5085E), msg.conversationIndex!.header.guid)
        XCTAssertEqual(0, msg.conversationIndex!.responseLevels.count)
        ...
        XCTAssertEqual(GUID(0x2907DA59, 0xAF9D, 0x4A5C, 0xB20C, 0x8B81A78C96C0), (msg.birthdayEventEntryId as? GeneralEntryID)!.providerUid)
        ...
        XCTAssertEqual(GUID(0x2907DA59, 0xAF9D, 0x4A5C, 0xB20C, 0x8B81A78C96C0), (msg.referenceEntryId as? GeneralEntryID)!.providerUid)
        ...
        XCTAssertEqual(GUID(0x2907DA59, 0xAF9D, 0x4A5C, 0xB20C, 0x8B81A78C96C0), (msg.anniversaryEventEntryId as? GeneralEntryID)!.providerUid)
        ...
        XCTAssertEqual(GUID(0xA41F2B81, 0xA3BE, 0x1910, 0x9D6E, 0x00DD010F5402), msg.fax2OriginalEntryId!.providerUid)
    ...
    func testReadMine6() throws {
        ...
        XCTAssertEqual(GUID(0x00000000, 0x42FE, 0x0AAA, 0x18C7, 0x1A10E8850B65), (msg.contactLinkEntry!.addrBookEntryIdData[0] as? GeneralEntryID)!.providerUid)
        ...
        XCTAssertEqual(0x01, msg.conversationIndex!.header.reserved)
        XCTAssertEqual(857381369499.0, msg.conversationIndex!.header.currentFileTime.timeIntervalSince1970)
        XCTAssertEqual(GUID(0x5D4AFFBB, 0x7975, 0x412A, 0xA5DD, 0x6F93F9C0FF85), msg.conversationIndex!.header.guid)
        XCTAssertEqual(0, msg.conversationIndex!.responseLevels.count)
        XCTAssertEqual([.unicodeOk, StoreSupportMask(rawValue: 0x00000E79)], msg.storeSupportMask)
        XCTAssertEqual("SMTP", (msg.getProperty(id: .tagSenderAddressType) as String?)!)
    ...
    func testReadMine7() throws {
        ...
        XCTAssertEqual(1033, (msg.getProperty(set: .common, lid: 0x000085EB) as UInt32?)!)
        XCTAssertEqual(0x01, msg.conversationIndex!.header.reserved)
        XCTAssertEqual(1154421912422.0, msg.conversationIndex!.header.currentFileTime.timeIntervalSince1970)
        XCTAssertEqual(GUID(0x2AA88820, 0x7014, 0x4990, 0xA064, 0x4C9A2E6CC0EF), msg.conversationIndex!.header.guid)
        XCTAssertEqual(0, msg.conversationIndex!.responseLevels.count)
        XCTAssertEqual("00000002\u{01}hughbellars@gmail.com", msg.internetAccountStamp!)
    ...
    func testReadMine8() throws {
        ...
        XCTAssertEqual("hughbellars@gmail.com", msg.receivedRepresentingEmailAddress!)
        XCTAssertEqual(0x01, msg.conversationIndex!.header.reserved)
        XCTAssertEqual(569376173327.0, msg.conversationIndex!.header.currentFileTime.timeIntervalSince1970)
        XCTAssertEqual(GUID(0x9259737E, 0x219E, 0xAC97, 0xAAC0, 0xB096DCFA75FA), msg.conversationIndex!.header.guid)
        XCTAssertEqual(0, msg.conversationIndex!.responseLevels.count)
    ...
    func testReadMine9() throws {
        ...
        XCTAssertEqual(0x01, msg.conversationIndex!.header.reserved)
        XCTAssertEqual(485243302790.0, msg.conversationIndex!.header.currentFileTime.timeIntervalSince1970)
        XCTAssertEqual(GUID(0xDD903BC8, 0xCEEC, 0x4E5A, 0x8834, 0xD53C835F6961), msg.conversationIndex!.header.guid)
        XCTAssertEqual(0, msg.conversationIndex!.responseLevels.count)
        ...
        XCTAssertEqual("SMTP", (msg.recipients[0].entryId as? OneOffEntryID)!.addressType)
        XCTAssertEqual("bellamy.hughd@gmail.com", (msg.recipients[0].entryId as? OneOffEntryID)!.emailAddress)
        XCTAssertEqual("bellamy.hughd@gmail.com", (msg.recipients[0].getProperty(id: .PR_DOTSTUFF_STATE_OR_PR_NICK_NAME_W) as String?)!)
        XCTAssertEqual("SMTP", msg.recipients[0].addressType!)
    ...
    func testReadMine10() throws {
        ...
        XCTAssertEqual("SMTP", msg.sentRepresentingAddressType!)
        XCTAssertEqual([0x42, 0x6F, 0x64, 0x79, 0x0D, 0x0A, 0x0D, 0x0A], [UInt8]((msg.getProperty(guid: GUID(0x4E3A7680, 0xB77A, 0x11D0, 0x9DA5, 0x00C04FD65685), name: "Internet Charset Body") as Data?)!))
        XCTAssertEqual([0x53, 0x4D, 0x54, 0x50, 0x3A, 0x48, 0x55, 0x47, 0x48, 0x42, 0x45, 0x4C, 0x4C, 0x41, 0x52, 0x53, 0x40, 0x47, 0x4D, 0x41, 0x49, 0x4C, 0x2E, 0x43, 0x4F, 0x4D, 0x00], [UInt8](msg.receivedRepresentingSearchKey!))
        XCTAssertEqual("", msg.subjectPrefix!)
        XCTAssertEqual(.normal, msg.importance!)
        XCTAssertEqual("00000002\u{01}hughbellars", msg.internetAccountStamp!)
        ...
        XCTAssertEqual(0x01, msg.conversationIndex!.header.reserved)
        XCTAssertEqual(1781773340513.0, msg.conversationIndex!.header.currentFileTime.timeIntervalSince1970)
        XCTAssertEqual(GUID(0x6D8CD5F8, 0xE3D8, 0x9537, 0x4FD6, 0x3D9DC4685E3F), msg.conversationIndex!.header.guid)
        XCTAssertEqual(0, msg.conversationIndex!.responseLevels.count)
        XCTAssertEqual("Body\r\n\r\n", msg.body!)
        XCTAssertEqual(.readOnly, msg.accessLevel!)
        XCTAssertEqual(0x00000000, (msg.receivedByEntryId as? OneOffEntryID)!.flags)
    ...
    func testReadMine11() throws {
        ...
        XCTAssertEqual(GUID(0xF711B14A, 0x92C8, 0x4094, 0x9843, 0x750BE6086BC4), msg.changeKey!.namespaceGuid)
        ...
        XCTAssertEqual("IPM.Note", msg.messageClass!)
        XCTAssertEqual(1, msg.predecessorChangeList!.values.count)
        XCTAssertEqual(GUID(0xF711B14A, 0x92C8, 0x4094, 0x9843, 0x750BE6086BC4), msg.predecessorChangeList!.values[0].namespaceGuid)
        ...
        XCTAssertEqual(GUID(0x38433B49, 0x39D1, 0x4EF7, 0xD4EA, 0x08D8710BC0F5), (msg.getProperty(set: .common, name: "NetworkMessageId") as GUID?)!)
        ...
        XCTAssertEqual(GUID(0x7F8587FE, 0x323C, 0x4220, 0x9C5F, 0x2907EB106A78), (msg.getProperty(guid: GUID(0x0B63E350, 0x9CCC, 0x11D0, 0xBCDB, 0x00805FCCCE04), name: "BigFunnelCorrelationId") as GUID?)!)
        ...
        XCTAssertEqual(0x01, msg.conversationIndex!.header.reserved)
        XCTAssertEqual(209228940627.0, msg.conversationIndex!.header.currentFileTime.timeIntervalSince1970)
        XCTAssertEqual(GUID(0xB750617C, 0x2704, 0x466F, 0x8F8D, 0x7F1A9CB5DEC6), msg.conversationIndex!.header.guid)
        XCTAssertEqual(1, msg.conversationIndex!.responseLevels.count)
        XCTAssertEqual(7995, msg.conversationIndex!.responseLevels[0].deltaTime)
        XCTAssertFalse(msg.conversationIndex!.responseLevels[0].deltaCode)
        ...
        XCTAssertEqual(.normal, msg.priority!)
        XCTAssertEqual("la", (msg.getProperty(guid: GUID(0x0B63E350, 0x9CCC, 0x11D0, 0xBCDB, 0x00805FCCCE04), name: "DetectedLanguage") as String?)!)
        XCTAssertEqual(GUID(0xB71D3DDC, 0x5B41, 0x4C92, 0xAEE2, 0xC2FEF93AC9BC), (msg.getProperty(set: .xmlExtractedEntities, name: "InferenceMessageIdentifier") as GUID?)!)
        XCTAssertEqual(1602767461.0, (msg.getProperty(guid: GUID(0x0B63E350, 0x9CCC, 0x11D0, 0xBCDB, 0x00805FCCCE04), name: "LastIndexingAttemptTime") as Date?)!.timeIntervalSince1970)
        ...
        XCTAssertEqual("BT=1;II=[CID=75fcfedf-c403-9a35-bb38-061777b6f11d;IDXHEAD=014A90EF6B;IDXCOUNT=2];SBMID=98;S1=<LNXP123MB3820CD99E45451F765E2D646CB020@LNXP123MB3820.GBRP123.PROD.OUTLOOK.COM>;RTP=DirectChild;TDN=Removed;TFR=ParticipantChanged;FIXUP=101.0661;Version=Version 15.20 (Build 3455.0), Stage=H2, TC;UP=50;DP=5;QT=1;CPBT=A0000000EC028C7BF0462B9E", (msg.getProperty(guid: GUID(0x33EBA41F, 0x7AA8, 0x422E, 0xBE7B, 0x79E1A98E54B3), name: "ConversationIndexTrackingEx") as String?)!)
        XCTAssertTrue((msg.getProperty(set: .common, name: "EntityExtractionSuccessDelayed") as Bool?)!)
        XCTAssertEqual(13, (msg.getProperty(id: .unknown0x3668) as UInt32?)!)
