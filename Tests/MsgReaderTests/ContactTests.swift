...
final class ContactTests: XCTestCase {
    public func testSimpleContact() throws {
        ...
        XCTAssertEqual(GUID(0x3C8DC689, 0x12D3, 0x491A, 0xA216, 0xD9520DDDDEE0), msg.conversationIndex!.header.guid)
    ...
    public func testContactGroup() throws {
        ...
        XCTAssertEqual(GUID(0xEEBD77F1, 0xC9A1, 0x4274, 0xAD40, 0x6A6AE6AA82F6), msg.conversationIndex!.header.guid)
        XCTAssertEqual(0, msg.conversationIndex!.responseLevels.count)
        ...
        XCTAssertEqual(GUID(0xA41F2B81, 0xA3BE, 0x1910, 0x9D6E, 0x00DD010F5402), (msg.distributionListOneOffMembers![0] as? OneOffEntryID)!.providerUid)
        ...
        XCTAssertEqual(GUID(0xA41F2B81, 0xA3BE, 0x1910, 0x9D6E, 0x00DD010F5402), (msg.distributionListOneOffMembers![1] as? OneOffEntryID)!.providerUid)
        ...
        XCTAssertEqual(GUID(0xD3AD91C0, 0x9D51, 0x11CF, 0xA4A9, 0x00AA0047FAA4), (msg.distributionListMembers![0] as? WrappedEntryId)!.providerUid)
        ...
        XCTAssertEqual(GUID(0x6794B8CB, 0x06E6, 0x4842, 0xA820, 0x9CC1E3B9A128), ((msg.distributionListMembers![0] as? WrappedEntryId)!.embeddedEntryID as? MessageEntryID)!.providerUid)
        ...
        XCTAssertEqual(GUID(0xF711B14A, 0x92C8, 0x4094, 0x9843, 0x750BE6086BC4), ((msg.distributionListMembers![0] as? WrappedEntryId)!.embeddedEntryID as? MessageEntryID)!.folderDatabaseGuid)
        ...
        XCTAssertEqual(GUID(0xF711B14A, 0x92C8, 0x4094, 0x9843, 0x750BE6086BC4), ((msg.distributionListMembers![0] as? WrappedEntryId)!.embeddedEntryID as? MessageEntryID)!.messageDatabaseGuid)
        ...
        XCTAssertEqual(GUID(0xD3AD91C0, 0x9D51, 0x11CF, 0xA4A9, 0x00AA0047FAA4), (msg.distributionListMembers![1] as? WrappedEntryId)!.providerUid)
        ...
        XCTAssertEqual(GUID(0x6794B8CB, 0x06E6, 0x4842, 0xA820, 0x9CC1E3B9A128), ((msg.distributionListMembers![1] as? WrappedEntryId)!.embeddedEntryID as? MessageEntryID)!.providerUid)
        ...
        XCTAssertEqual(GUID(0xF711B14A, 0x92C8, 0x4094, 0x9843, 0x750BE6086BC4), ((msg.distributionListMembers![1] as? WrappedEntryId)!.embeddedEntryID as? MessageEntryID)!.folderDatabaseGuid)
        ...
        XCTAssertEqual(GUID(0xF711B14A, 0x92C8, 0x4094, 0x9843, 0x750BE6086BC4), ((msg.distributionListMembers![1] as? WrappedEntryId)!.embeddedEntryID as? MessageEntryID)!.messageDatabaseGuid)
