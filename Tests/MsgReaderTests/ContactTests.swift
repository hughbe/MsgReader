...
final class ContactTests: XCTestCase {
    public func testSimpleContact() throws {
        ...
        XCTAssertEqual(0x97, msg.conversationIndex!.header.currentFileTime.1)
        XCTAssertEqual(0xF2, msg.conversationIndex!.header.currentFileTime.2)
        XCTAssertEqual(0x05, msg.conversationIndex!.header.currentFileTime.3)
        XCTAssertEqual(0x91, msg.conversationIndex!.header.currentFileTime.4)
