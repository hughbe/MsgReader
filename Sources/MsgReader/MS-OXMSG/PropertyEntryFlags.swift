...
internal struct PropertyEntryFlags: OptionSet {
    ...
    public static let mandatory = PropertyEntryFlags(rawValue: 0x00000001)
    ...
    public static let readable = PropertyEntryFlags(rawValue: 0x00000002)
    ...
    public static let writable = PropertyEntryFlags(rawValue: 0x00000004)

    public static let all: PropertyEntryFlags = [.mandatory, .readable, .writable]
}
